...
impl<S: Clone> DynAttrEffect<S> {
    ...
    pub fn new_infinite_basic_add(from_name: S, effect_name: S, value: f64) -> Self {
        Self::new_infinite(DynAttrEffectType::BasicAdd, from_name, effect_name, value)
    }

    pub fn new_infinite_final_multi(from_name: S, effect_name: S, value: f64) -> Self {
        Self::new_infinite(DynAttrEffectType::FinalMulti, from_name, effect_name, value)
    }

    pub fn new_infinite_basic_percent(from_name: S, effect_name: S, value: f64) -> Self {
        Self::new_infinite(DynAttrEffectType::BasicPercent, from_name, effect_name, value)
    }

    pub fn new_infinite_final_percent(from_name: S, effect_name: S, value: f64) -> Self {
        Self::new_infinite(DynAttrEffectType::FinalPercent, from_name, effect_name, value)
    }

    // =================================================================================

    pub fn new_duration_basic_add(from_name: S, effect_name: S, value: f64, duration_time: f64) -> Self {
        Self::new_duration(DynAttrEffectType::BasicAdd, from_name, effect_name, value, duration_time)
    }

    pub fn new_duration_final_multi(from_name: S, effect_name: S, value: f64, duration_time: f64) -> Self {
        Self::new_duration(DynAttrEffectType::FinalMulti, from_name, effect_name, value, duration_time)
    }

    pub fn new_duration_basic_percent(from_name: S, effect_name: S, value: f64, duration_time: f64) -> Self {
        Self::new_duration(DynAttrEffectType::BasicPercent, from_name, effect_name, value, duration_time)
    }

    pub fn new_duration_final_percent(from_name: S, effect_name: S, value: f64, duration_time: f64) -> Self {
